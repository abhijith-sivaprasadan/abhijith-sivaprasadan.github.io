...
const featuredIds = ['pypsa-nl-grid-flexibility', 'pynexus-green-hydrogen', 'industrial-energy-kpi-toolkit', 'eu-ets-exposure-calculator', 'thermotwin-f', 'non-gray-radiation-modeling'];
