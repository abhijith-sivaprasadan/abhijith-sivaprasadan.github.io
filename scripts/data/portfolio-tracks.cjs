...
module.exports = [
  {
    ...
    projects: ['siemens-thesis', 'gb-flexabm', 'alleima-energy-efficiency', 'thermotwin-f', 'industrial-energy-kpi-toolkit', 'robotic-frame-locomotion'],
  ...
  },
  {
    ...
    projects: ['gb-flexabm', 'pypsa-nl-grid-flexibility', 'pynexus-green-hydrogen', 'district-heating-optimisation', 'heating-demand-forecasting', 'alleima-energy-efficiency'],
    ...
    scope: 'GB-FLEXABM is synthetic and uncalibrated; PyPSA-NL uses a synthetic topology. Neither is a validated national-system forecast. PyNEXUS has a synthetic 168-hour reference, not an annual-run claim. Alleima work was desk-based methodology, not implemented plant savings. Python applications run locally, not on GitHub Pages.',
  },
  {
    ...
    projects: ['industrial-energy-kpi-toolkit', 'gb-flexabm', 'thermotwin-f', 'non-gray-radiation-modeling', 'eu-ets-exposure-calculator', 'heating-demand-forecasting'],
  ...
  },
  {
    ...
    projects: ['siemens-thesis', 'non-gray-radiation-modeling', 'gb-flexabm', 'numerical-heat-transfer', 'heating-demand-forecasting', 'robotic-frame-locomotion'],
